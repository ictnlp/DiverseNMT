...
class Trainer(object):
    ...
    def init_meters(self, args):
        ...
        self.meters['nmt_loss'] = AverageMeter()
        self.meters['lm_loss'] = AverageMeter()
    ...
    def train_step(self, samples, dummy_batch=False):
        ...
        try:
            ...
            self.meters['nmt_loss'].update(logging_output.get('nmt_loss', 0))
            self.meters['lm_loss'].update(logging_output.get('lm_loss', 0))
